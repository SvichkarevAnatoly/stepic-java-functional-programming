...
interface RequestHandler {
    ...
    default RequestHandler andThan(RequestHandler nextHandler) {
        return req -> nextHandler.handle(handle(req));
    }
}
...
final static RequestHandler commonRequestHandler =
    wrapInTransactionTag.andThan(createDigest)
            .andThan(wrapInRequestTag);
